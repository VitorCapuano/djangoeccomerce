# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-11-14 02:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name=b'Criado em')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name=b'Modificado em')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.Category', verbose_name=b'Categoria')),
            ],
            options={
                'ordering': ['name'],
